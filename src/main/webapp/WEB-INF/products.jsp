...
<html>
    ...
    <body>
        ...
        <header id="header"> 
           <div class="f_section_liste" style="background-image: url(sources/c8c88dff059abc16ba224da45162d992.jpg); border-bottom:2px lightgrey solid; text-align:center;">
               <% Categorie categorie = (Categorie) request.getAttribute("unique_categorie"); %>
               <h2 style="color:#333; padding:0px; margin:0px; position:relative; top:210px; padding:20px; border-radius:2px; color:white; background-color:#333; display:inline-block;"><%= categorie.getNom() %></h2>
        ...
        <main>
            ...
            <secion id="s_section">
               ...
               <%
                 ArrayList<Produit> listProduit = (ArrayList<Produit>) request.getAttribute("produits");
                 int i = 0;
                 for (Produit produit : listProduit) {
                     if(i == 4){
                         %>
                            <div id="annonce"> <img src="sources/sangeeta-bisht-banner.jpg" /></div>
                         <%
                     }
                         %>
                         
                <article class="product">
                    <a href = "produitsControleur?id_pr=<%= produit.getId() %>" ><img src="<%= produit.getUrlImage() %>" style="width:100%"/></a>
                    <div class="product_description">
                        <span><%= produit.getDescription() %></span> 
                    </div>
                    <label><%= produit.getPrix() %> $ CAD</label>
                </article>
